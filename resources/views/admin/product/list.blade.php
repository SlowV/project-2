...
@section('css')
    ...
    <link href="http://www.cakeshopcafe.com/wp-content/uploads/2016/02/CSC_logo.png" rel="shortcut icon" type="http://www.cakeshopcafe.com/wp-content/uploads/2016/02/CSC_logo.png">
@stop
                        ...
                        @foreach($products as $item)
                            <tr>
                                ...
                                <td style="text-align: center">
                                    ...
                                    <div>&nbsp;</div>
                                    <div>
                                        <button class="btn btn-danger list-delete" data-toggle="modal" data-target="#exampleModal"
                                                style="width: 70px;" id="{{$item-> id}}"><i class="far fa-trash-alt"></i> Xóa
                                        </button>
                                    </div>
                                </td>
                            </tr>
